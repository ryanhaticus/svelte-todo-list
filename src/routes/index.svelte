<script>
	import { MenuIcon, XIcon } from '@rgossiaux/svelte-heroicons/solid';
...
<div class="min-h-screen relative bg-gray-50 overflow-hidden">
	...
	<div class="relative">
		<div class="flex flex-col min-h-screen pt-6 pb-16 sm:pb-24">
      ...
      -->
			...
			<main
				class="flex-grow flex items-center justify-center mt-16 mx-auto max-w-7xl px-4 sm:mt-24"
			>
				<div class="text-center">
					<h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
						<span class="block xl:inline">A todo list</span>
						<span class="block text-indigo-600 xl:inline">built in Svelte</span>
					</h1>
					<p
						class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl"
					>
						A Svelte app bootstrapped with SvelteKit, Firebase, and TailwindCSS.
					</p>
